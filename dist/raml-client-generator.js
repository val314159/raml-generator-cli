...
},{"hbsfy/runtime":47}],8:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":47}],10:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":47}],12:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var stack1;
...
},{"hbsfy/runtime":47}],13:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"../../lib/generator":26,"./helpers/flatPath":14,"./helpers/fullPath":15,"./helpers/getUriList":16,"./templates/rpc_requests.py.hbs":18,"./templates/test.py.hbs":19,"camel-case":33,"javascript-stringify":51}],18:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":47}],19:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "uri "
    ...
    + " "
    + alias1((helpers.keys || (depth0 && depth0.keys) || alias2).call(depth0,depth0,{"name":"keys","hash":{},"data":data}))
    + " "
    + alias1(((helper = (helper = helpers.required || (depth0 != null ? depth0.required : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(depth0,{"name":"required","hash":{},"data":data}) : helper)))
    + " "
...
},{"./parameters":22,"./resources":23,"./security":24,"./uri":25,"extend":39,"methods":53}],21:[function(require,module,exports){
...
},{"./parameters":22,"object.pick":54}],22:[function(require,module,exports){
var pick = require('object.pick');
...
},{"object.pick":54}],23:[function(require,module,exports){
var sanitizeUri        = require('./uri');
...
},{"./methods":21,"./parameters":22,"./uri":25}],24:[function(require,module,exports){
/**
 * Sanitize resources into nested object form.
 *
...
},{"./context":20,"./helpers":27,"extend":39,"handlebars":28}],27:[function(require,module,exports){
...
},{"camel-case":33,"constant-case":38,"indent-string":48,"lower-case":52,"param-case":59,"pascal-case":61,"snake-case":66,"upper-case":67}],28:[function(require,module,exports){
...
},{"sentence-case":34,"upper-case":67}],34:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":35,"./vendor/non-word-regexp":36,"./vendor/trailing-digit-regexp":37,"lower-case":52}],35:[function(require,module,exports){
...
},{"snake-case":66,"upper-case":67}],39:[function(require,module,exports){
var hasOwn = Object.prototype.hasOwnProperty;
...
},{"repeating":49}],49:[function(require,module,exports){
'use strict';
...
},{"is-finite":50}],50:[function(require,module,exports){
'use strict';
...
},{"http":28}],54:[function(require,module,exports){
/*!
...
},{"./vendor/camel-case-regexp":56,"./vendor/non-word-regexp":57,"./vendor/trailing-digit-regexp":58,"dup":34,"lower-case":52}],56:[function(require,module,exports){
...
},{"sentence-case":55}],60:[function(require,module,exports){
var upperCase = require('upper-case');
...
},{"upper-case":67}],61:[function(require,module,exports){
...
},{"camel-case":33,"upper-case-first":60}],62:[function(require,module,exports){
arguments[4][34][0].apply(exports,arguments)
},{"./vendor/camel-case-regexp":63,"./vendor/non-word-regexp":64,"./vendor/trailing-digit-regexp":65,"dup":34,"lower-case":52}],63:[function(require,module,exports){
arguments[4][35][0].apply(exports,arguments)
