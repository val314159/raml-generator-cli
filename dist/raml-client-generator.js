...
},{"hbsfy/runtime":52}],7:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"hbsfy/runtime":52}],8:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],9:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "node_modules\n";
...
},{"hbsfy/runtime":52}],10:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],11:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],12:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var stack1;
...
},{"hbsfy/runtime":52}],13:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":52}],14:[function(require,module,exports){
/**
 * Pull out request parameters from the resource.
 *
 * @param  {Object} resource
...
},{"fs":32}],18:[function(require,module,exports){
var generator = require('../../lib/generator');
...
},{"../../lib/generator":30,"./helpers/flatPath":14,"./helpers/fullPath":15,"./helpers/getUriList":16,"./helpers/importJson":17,"./templates/rpc_requests.py.hbs":19,"./templates/server_mock.py.hbs":20,"./templates/server_tornado.py.hbs":21,"./templates/server_wsgi.py.hbs":22,"./templates/test.py.hbs":23,"camel-case":38,"javascript-stringify":56}],19:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "def rpc"
    ...
    + "'\n\n   uri=path\n"
    + ((stack1 = helpers.each.call(depth0,((stack1 = (depth0 != null ? depth0.resource : depth0)) != null ? stack1.uriParameters : stack1),{"name":"each","hash":{},"fn":this.program(8, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n   query={}\n"
...
},{"hbsfy/runtime":52}],20:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "  def rpc"
    ...
    + "#form\n    ):\n    ###\n    #  put logic here\n    ###\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.body : depth0),{"name":"each","hash":{},"fn":this.program(10, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "    ###\n    return ['hello world']\n\n";
},"4":function(depth0,helpers,partials,data) {
    var helper;
  ...
  return ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.formParameters : depth0),{"name":"each","hash":{},"fn":this.program(11, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"11":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;
...
},{"hbsfy/runtime":52}],21:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return this.escapeExpression((helpers.getUriList || (depth0 && depth0.getUriList) || helpers.helperMissing).call(depth0,(depth0 != null ? depth0.resource : depth0),{"name":"getUriList","hash":{},"data":data}));
...
},{"hbsfy/runtime":52}],22:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return this.escapeExpression((helpers.getUriList || (depth0 && depth0.getUriList) || helpers.helperMissing).call(depth0,(depth0 != null ? depth0.resource : depth0),{"name":"getUriList","hash":{},"data":data}));
  ...
  return "    elif match(environ['PATH_INFO'],r'"
    + alias2((helpers.fullPath || (depth0 && depth0.fullPath) || alias1).call(depth0,(depth0 != null ? depth0.resource : depth0),{"name":"fullPath","hash":{},"data":data}))
    + "'):\n      return rpc"
    + alias2((helpers.flatPath || (depth0 && depth0.flatPath) || alias1).call(depth0,(depth0 != null ? depth0.resource : depth0),{"name":"flatPath","hash":{},"data":data}))
    + "_"
...
},{"hbsfy/runtime":52}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var stack1, helper, alias1=helpers.helperMissing, alias2=this.escapeExpression, alias3="function";
...
},{"hbsfy/runtime":52}],24:[function(require,module,exports){
...
},{"./parameters":26,"./resources":27,"./security":28,"./uri":29,"extend":44,"methods":58}],25:[function(require,module,exports){
...
},{"./parameters":26,"object.pick":59}],26:[function(require,module,exports){
var pick = require('object.pick');
...
},{"object.pick":59}],27:[function(require,module,exports){
var sanitizeUri        = require('./uri');
...
},{"./methods":25,"./parameters":26,"./uri":29}],28:[function(require,module,exports){
/**
 * Sanitize resources into nested object form.
 *
...
},{"./context":24,"./helpers":31,"extend":44,"handlebars":33}],31:[function(require,module,exports){
...
},{"camel-case":38,"constant-case":43,"indent-string":53,"lower-case":57,"param-case":64,"pascal-case":66,"snake-case":71,"upper-case":72}],32:[function(require,module,exports){
...
},{"sentence-case":39,"upper-case":72}],39:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":40,"./vendor/non-word-regexp":41,"./vendor/trailing-digit-regexp":42,"lower-case":57}],40:[function(require,module,exports){
...
},{"snake-case":71,"upper-case":72}],44:[function(require,module,exports){
var hasOwn = Object.prototype.hasOwnProperty;
...
},{"repeating":54}],54:[function(require,module,exports){
'use strict';
...
},{"is-finite":55}],55:[function(require,module,exports){
'use strict';
...
},{"http":33}],59:[function(require,module,exports){
/*!
...
},{"./vendor/camel-case-regexp":61,"./vendor/non-word-regexp":62,"./vendor/trailing-digit-regexp":63,"dup":39,"lower-case":57}],61:[function(require,module,exports){
...
},{"sentence-case":60}],65:[function(require,module,exports){
var upperCase = require('upper-case');
...
},{"upper-case":72}],66:[function(require,module,exports){
...
},{"camel-case":38,"upper-case-first":65}],67:[function(require,module,exports){
arguments[4][39][0].apply(exports,arguments)
},{"./vendor/camel-case-regexp":68,"./vendor/non-word-regexp":69,"./vendor/trailing-digit-regexp":70,"dup":39,"lower-case":57}],68:[function(require,module,exports){
arguments[4][40][0].apply(exports,arguments)
