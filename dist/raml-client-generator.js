...
},{"../../lib/generator":22,"./helpers/dependencies":1,"./helpers/parameters-snippet":2,"./helpers/request-snippet":3,"./helpers/testy":4,"./partials/auth.js.hbs":6,"./partials/client.js.hbs":7,"./partials/resources.js.hbs":8,"./partials/utils.js.hbs":9,"./templates/.gitignore.hbs":10,"./templates/INSTALL.md.hbs":11,"./templates/README.md.hbs":12,"./templates/TEST.md.hbs":13,"./templates/index.js.hbs":14,"./templates/package.json.hbs":15,"camel-case":29,"javascript-stringify":47}],6:[function(require,module,exports){
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "#MMMMMM------------------------------- "
    ...
    + "\n#keys . = "
    + alias3((helpers.keys || (depth0 && depth0.keys) || alias1).call(depth0,depth0,{"name":"keys","hash":{},"data":data}))
    + "\n\ndef "
    + alias3(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"id","hash":{},"data":data}) : helper)))
    + "(self,\n  "
    ...
    + " #uri\n  "
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.queryParameters : depth0),{"name":"each","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " # query\n  "
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.body : depth0),{"name":"each","hash":{},"fn":this.program(4, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + " # form\n  ):\n  \"\"\"\n  "
    ...
    + "\n  \"\"\"\n  resource = "
    + alias3(((helper = (helper = helpers.resource || (depth0 != null ? depth0.resource : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"resource","hash":{},"data":data}) : helper)))
    + "\n  keys resource = "
    + alias3((helpers.keys || (depth0 && depth0.keys) || alias1).call(depth0,(depth0 != null ? depth0.resource : depth0),{"name":"keys","hash":{},"data":data}))
    + "\n  resource.key = "
    + alias3(alias4(((stack1 = (depth0 != null ? depth0.resource : depth0)) != null ? stack1.key : stack1), depth0))
    + "\n  resource.relativeUri = "
    + alias3(alias4(((stack1 = (depth0 != null ? depth0.resource : depth0)) != null ? stack1.relativeUri : stack1), depth0))
    + "\n  keys resource.uriParameters = "
    + alias3((helpers.keys || (depth0 && depth0.keys) || alias1).call(depth0,((stack1 = (depth0 != null ? depth0.resource : depth0)) != null ? stack1.uriParameters : stack1),{"name":"keys","hash":{},"data":data}))
    + "  "
    + ((stack1 = helpers.each.call(depth0,((stack1 = (depth0 != null ? depth0.resource : depth0)) != null ? stack1.uriParameters : stack1),{"name":"each","hash":{},"fn":this.program(6, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n  return\n\n";
},"2":function(depth0,helpers,partials,data) {
    var helper;
  ...
  return ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.formParameters : depth0),{"name":"each","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
},"6":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":43}],15:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":43}],16:[function(require,module,exports){
...
},{"./parameters":18,"./resources":19,"./security":20,"./uri":21,"extend":35,"methods":49}],17:[function(require,module,exports){
...
},{"./parameters":18,"object.pick":50}],18:[function(require,module,exports){
var pick = require('object.pick');
...
},{"object.pick":50}],19:[function(require,module,exports){
var sanitizeUri        = require('./uri');
...
},{"./methods":17,"./parameters":18,"./uri":21}],20:[function(require,module,exports){
/**
 * Sanitize resources into nested object form.
 *
...
},{"./context":16,"./helpers":23,"extend":35,"handlebars":24}],23:[function(require,module,exports){
...
},{"camel-case":29,"constant-case":34,"indent-string":44,"lower-case":48,"param-case":55,"pascal-case":57,"snake-case":62,"upper-case":63}],24:[function(require,module,exports){
...
},{"sentence-case":30,"upper-case":63}],30:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":31,"./vendor/non-word-regexp":32,"./vendor/trailing-digit-regexp":33,"lower-case":48}],31:[function(require,module,exports){
...
},{"snake-case":62,"upper-case":63}],35:[function(require,module,exports){
var hasOwn = Object.prototype.hasOwnProperty;
...
},{"http":24}],50:[function(require,module,exports){
/*!
...
},{"./vendor/camel-case-regexp":52,"./vendor/non-word-regexp":53,"./vendor/trailing-digit-regexp":54,"dup":30,"lower-case":48}],52:[function(require,module,exports){
...
},{"sentence-case":51}],56:[function(require,module,exports){
var upperCase = require('upper-case');
...
},{"upper-case":63}],57:[function(require,module,exports){
...
},{"camel-case":29,"upper-case-first":56}],58:[function(require,module,exports){
arguments[4][30][0].apply(exports,arguments)
},{"./vendor/camel-case-regexp":59,"./vendor/non-word-regexp":60,"./vendor/trailing-digit-regexp":61,"dup":30,"lower-case":48}],59:[function(require,module,exports){
arguments[4][31][0].apply(exports,arguments)
...
},{"sentence-case":58}],63:[function(require,module,exports){
/**
 * Special language-specific overrides.
 *
 * Source: ftp://ftp.unicode.org/Public/UCD/latest/ucd/SpecialCasing.txt
